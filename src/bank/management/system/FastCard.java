...
public class FastCard extends JFrame implements ActionListener{
      JButton deposit , withdrawl , fastcash , ministatement , pinchange , balanceenquiry, exit;
    String pinnumber;
FastCard(String pinnumber){
...
public void actionPerformed(ActionEvent ae){
   ...
   try{
       ...
       JOptionPane.showMessageDialog(null, "Insufficiaent Balance");
       return;
       }
       ...
       JOptionPane.showMessageDialog(null,"Collect your Muggle cash of Rs "+amount);
