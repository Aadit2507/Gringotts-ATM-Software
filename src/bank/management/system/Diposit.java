...
public class Diposit extends JFrame implements ActionListener {
    ...
    Diposit(String pinnumber){
     this.pinnumber = pinnumber;
         ...
         deposit.setBounds(359,530 , 150 , 30);
     ...
     public void actionPerformed(ActionEvent ae){
         ...
         if(ae.getSource()==deposit){
             ...
             JOptionPane.showMessageDialog(null, "Please enter the amount you want to deposit");
                 ...
                 try{
                        Conn conn = new Conn();
             String query  =  "insert into bank values('"+pinnumber+"','"+date+"','deposit','"+numb+"')";
             conn.s.executeUpdate(query);
             JOptionPane.showMessageDialog(null, "Rs "+numb+" has been deposited succeessfully");
              setVisible(false);
