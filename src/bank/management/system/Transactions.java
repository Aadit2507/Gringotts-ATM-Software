...
public class Transactions extends JFrame implements ActionListener{
      JButton deposit , withrawl , fastcash , ministatement , pinchange , balanceenquiry, exit;
    String pinnumber;
Transactions(String pinnumber){
    ...
    setLayout(null);
       ...
       deposit.addActionListener(this);
        ...
        withrawl.setBounds(350 , 450 , 150 , 30);
        withrawl.addActionListener(this);
        image.add(withrawl);
        
         fastcash = new JButton("Muggle Money");
        ...
        balanceenquiry.setBounds(350 , 530 , 150 , 30);
        balanceenquiry.addActionListener(this);
        image.add(balanceenquiry);
        
    
         exit = new JButton("Exit");
        exit.setBounds(350 , 565 , 150 , 30);
...
public void actionPerformed(ActionEvent ae){
    ...
    setVisible(false);
    new FastCard(pinnumber).setVisible(true);
    }
    ...
    //setVisible(false); yeh sirf hide kr ta he 
    System.exit(0); // yeh terminate krta he
